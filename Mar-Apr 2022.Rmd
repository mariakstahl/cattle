...
## Load in collar data
```{r}
cattle.dat.new = read.csv('GPS Combined 3.15.22-4.7.22.csv')
...
collars = unique(cattle.utm.drill$CollarSerialNumber)
last_day_collars = tapply(X = cattle.utm.drill$Julianday, 
                          INDEX = cattle.utm.drill$CollarSerialNumber,
                          FUN = max)
last_day_collars
```
